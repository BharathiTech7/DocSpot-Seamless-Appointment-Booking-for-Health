...
const Notification = () => {
   ...
   const handleAllMarkRead = async () => {
      try {
         const res = await axios.post('https://docspot-backend-8jk2.onrender.com/api/user/getallnotification', { userId: user._id }, {
            headers: {
   ...
   const handledeleteAllMark = async () => {
      try {
         const res = await axios.post('https://docspot-backend-8jk2.onrender.com/api/user/deleteallnotification', { userId: user._id }, {
            headers: {
               Authorization: `Bearer ${localStorage.getItem('token')}`,
            },
         })
